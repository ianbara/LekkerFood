...
namespace LekkerFood.Repository.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<LekkerDbContext>
    {
        ...
        protected override void Seed(LekkerDbContext context)
        {
